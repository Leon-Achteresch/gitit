  ...
  return (
    <div className={cn("grid grid-cols-2 gap-3 xl:grid-cols-4", className)}>
      ...
      >
        ...
        />
        {statusLoaded ? (
          <div className="flex flex-wrap gap-x-3 gap-y-0.5 text-[0.625rem] text-muted-foreground">
      ...
      >
        ...
        />
        <div className="flex flex-wrap items-center gap-x-3 gap-y-0.5 text-[0.625rem] text-muted-foreground">
          {branchActivity ? (
            <span>
