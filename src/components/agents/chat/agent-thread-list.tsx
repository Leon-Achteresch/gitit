      ...
      <section className="min-w-0 px-2 pb-4">
        {hasQuery ? (
          <AgentsEnter className="flex flex-col items-center justify-center px-4 py-8 text-center">
            ...
            <p className="text-[0.75rem] font-medium text-[var(--ag-text-2)]">
            ...
            >
              {item.kind === "header" ? (
                <div className="flex items-center gap-2 px-2.5 pb-1.5 pt-3">
                  <h3 className="text-[0.625rem] font-medium tracking-[0.02em] text-[var(--ag-text-3)] text-[0.625rem] font-semibold uppercase tracking-wider text-[var(--ag-text-3)]">
